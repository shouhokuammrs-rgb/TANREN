...
最終更新: 2026-07-18 / 更新者: Engineer(Phase 5クラウド自動バックアップ完了報告)
...
| DEC-006 | DEC-000を部分改訂: ローカルファースト維持のままバックアップ用途に限りSupabase導入(フル同期なし)。データ喪失2件の恒久対策 | Eiichi/PM | 2026-07-18 |
