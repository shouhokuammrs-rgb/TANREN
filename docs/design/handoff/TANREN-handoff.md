...
| `#C9B79C` | steel | **維持モード**(完成した鉄)の値・ラベル・✓ |
| `#57503F` | steel-line | 維持モードの枠・スタートマーカー |

### 意味色の使い分け(3系統・混ぜない)
| 系統 | 色 | 意味 |
|---|---|---|
| 溶鉄 | `#FF5C1A` / `#FFB300` | 成長・進行中・達成の熱 |
| 鈍色 | `#8A5A3C` / `#6B5A4C` | 回復待ち・到達不能(capped)|
| 鋼色 | `#C9B79C` / `#57503F` | **維持モード**(DEC-013 確定)|

- 維持モード背景: `rgba(201,183,156,.05)` / 枠: `#57503F` 1px
- 鋼色にグローは付けない(熱を失っても強い、という意味を発光の有無で分ける)
